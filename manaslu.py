...
import pandas as pd
datalist=[]
urls=['https://www.nepalhikingteam.com/package/manaslu-circuit-trek/','https://www.nepalhikingteam.com/package/manaslu-circuit-trekking/',
      'https://www.nepalhikingteam.com/package/tsum-valley-manaslu-trek/']
...
df.to_csv('manaslu.csv',index=False)